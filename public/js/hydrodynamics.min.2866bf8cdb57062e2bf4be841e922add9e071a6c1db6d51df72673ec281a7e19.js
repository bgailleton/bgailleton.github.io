const NX=256,NY=256,DT=.5,DX=10,GRAVITY=9.81,MANNING=.035,HFLOW_THRESHOLD=1e-4,FROUDE_LIMIT=.85,HILLSHADE_THRESHOLD=.1,DEFAULT_DEPTH_COLOR_SCALE=2.5,SUN_ZENITH_RAD=34*Math.PI/180,SUN_AZIMUTH_RAD=90*Math.PI/180,DEFAULT_HILL_EXAGGERATION=1.5,DISPLAY_UPDATE_STEPS=30,GRAPHFLOOD_DT=.01,GRAPHFLOOD_ITERATIONS=20,GRAPHFLOOD_WARMUP_ITERATIONS=20,GRAPHFLOOD_MANNING=.033,GRAPHFLOOD_FILL_STEP=1e-4,BC_DEFAULT=0,BC_OUTFLOW=1,SECONDS_PER_YEAR=365*24*3600,PRECIP_DEFAULT_MM_PER_YR=10,MAX_BOUNDARY_ENTRIES=4,BOUNDARY_ENTRY_WINDOW=10,MODE_TRANSIENT="transient",MODE_STATIONARY="stationary",DISPLAY_MODE_DEPTH="depth",DISPLAY_MODE_DISCHARGE="discharge",QW_SCALE_MIN=.1,QW_SCALE_MAX=500,DEFAULT_QW_SCALE=100,DEFAULT_QW_OPACITY=.65,vertexShaderSrc=`
attribute vec2 aPos;
attribute vec2 aUV;
varying vec2 vUV;
void main() {

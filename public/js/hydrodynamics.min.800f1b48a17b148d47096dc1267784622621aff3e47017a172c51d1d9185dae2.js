const NX=256,NY=256,DT=.5,DX=10,GRAVITY=9.81,MANNING=.035,HFLOW_THRESHOLD=1e-4,FROUDE_LIMIT=.85,HILLSHADE_THRESHOLD=.1,DEFAULT_DEPTH_COLOR_SCALE=2.5,SUN_ZENITH_RAD=34*Math.PI/180,SUN_AZIMUTH_RAD=90*Math.PI/180,DEFAULT_HILL_EXAGGERATION=1.5,DISPLAY_UPDATE_STEPS=30,GRAPHFLOOD_DT=.01,GRAPHFLOOD_ITERATIONS=1e4,GRAPHFLOOD_MANNING=.033,MODE_TRANSIENT="transient",MODE_STATIONARY="stationary",vertexShaderSrc=`
attribute vec2 aPos;
attribute vec2 aUV;
varying vec2 vUV;
void main() {

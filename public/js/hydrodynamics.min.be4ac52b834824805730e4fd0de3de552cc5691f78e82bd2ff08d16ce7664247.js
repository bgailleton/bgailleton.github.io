...
void main() {
  ...
  h = max(h + dh, 0.0) + uPrecipRate * uDT;
...
vec3 hillshade(vec2 uv) {
  ...
  return mix(vec3(0.12, 0.14, 0.18), vec3(0.9, 0.92, 0.95), inverted);
}
